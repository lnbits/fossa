...
Use the templates provided <a href="docs/Cutting template.pdf">here</a>. print out at 100% on standard UK A4, and check the dimensions are correct after printing. The black lines are cut lines. The blue lines indicate the footprint of the devices.  It is useful if the pins on the bill acceptor and coin mech are accessible.
